...
export function WastewaterForm({
  ...
  // 3. FUNGSI BARU UNTUK MENGELOLA SUFFIX NO. SAMPEL
  ...
  // 4. VARIABEL BARU UNTUK MENGAMBIL NILAI SUFFIX DARI STATE
                ...
                <React.Fragment key={`${param.name}-${index}`}>
                  ...
                  <div className="border rounded-lg p-4 space-y-4 bg-muted/20">
                    <div className="flex justify-between items-center">
                      ...
                      {/* --- JUDUL PARAMETER DIUBAH MENJADI INPUT --- */}
