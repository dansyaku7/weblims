...
>(({ data }, ref) => {
  ...
  return (
    //  --- PERBAIKAN UTAMA: Struktur Flexbox ---
    //  Div ini sekarang menjadi container utama yang mengatur layout secara vertikal
    <div
      ref={ref}
      className="p-10 font-serif text-black bg-white relative flex flex-col"
      style={{ width: "210mm", minHeight: "297mm" }}
    >
      {/* Watermark Logo, biarkan di sini */}
      ...
      {/* Header, Main, dan Footer sekarang menjadi anak langsung dari container flex */}
      {/* Kita hilangkan 1 div wrapper yang tidak perlu */}
      ...
      {/* Konten Utama */}
      {/* className 'flex-grow' akan membuat <main> mengisi semua sisa ruang vertikal */}
      <main className="relative z-10 text-[9px] flex-grow">
        ...
        {/* Semua tabel dan konten lainnya tetap di dalam <main> */}
      ...
      {/* Footer akan otomatis terdorong ke bawah karena <main> mengisi ruang */}
