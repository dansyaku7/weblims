...
export default function StatCards({ data }: { data: any }) {
  // Parsing aman jika data belum datang
  const suhu = data?.suhu_mentah ? parseFloat(data.suhu_mentah).toFixed(1) : "--.-";
    ...
    <div className="grid gap-6 md:grid-cols-3">
        ...
        <CardContent className="p-6">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <p className="text-4xl font-extrabold text-white">{suhu}<span className="text-2xl text-zinc-500 font-medium">°C</span></p>
            </div>
          ...
          <div className="mt-5 flex items-center text-sm">
            <span className="text-zinc-400 text-xs font-mono">RoR (Laju): {ror} °C/s</span>
          </div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-6">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              ...
              <p className="text-4xl font-extrabold text-white">{gas}</p>
            </div>
          ...
          <div className="mt-5 flex items-center text-sm">
            <span className="text-zinc-400 text-xs font-mono">Baseline (MA): {maGas} Poin</span>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-zinc-900/40 border border-zinc-800 shadow-xl relative overflow-hidden group hover:border-red-500/50 transition-colors">
        ...
        <CardContent className="p-6">
          <div className="flex justify-between items-start">
            <div className="space-y-2">
              <p className="text-xs font-bold text-zinc-500 tracking-widest uppercase">Deteksi Api (Flame)</p>
              <p className="text-4xl font-extrabold text-emerald-400">{api}</p>
            </div>
          ...
          <div className="mt-5 flex items-center text-sm">
            <span className="text-zinc-400 text-xs">Aman: ~4095 | Bahaya: &lt; 1500</span>
          </div>
        </CardContent>
      </Card>
    </div>
